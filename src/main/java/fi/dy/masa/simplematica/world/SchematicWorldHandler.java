...
public class SchematicWorldHandler
{
    ...
    public void recreateSchematicWorld(boolean remove)
    {
        if (remove)
        {
            Simplematica.debugLog("Removing the schematic world...");
            if (this.world != null)
            {
        ...
        {
            Simplematica.debugLog("(Re-)creating the schematic world...");
            ...
            Simplematica.debugLog("Schematic world (re-)created: {}", this.world);
        }
