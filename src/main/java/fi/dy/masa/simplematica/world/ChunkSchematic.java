package fi.dy.masa.simplematica.world;
...
//                this.isUnsaved();
    ...
    public void setBlockEntity(@NonNull BlockEntity te)
    {
        ...
        {
            Simplematica.LOGGER.error("setBlockEntity: Can't set block entity at pos '{}', because the existing state '{}' doesn't accept block entities",
        ...
        else
        {
            ...
            if (!teState.equals(currState) && te.getType().isValid(currState))
            {
                ...
                {
                    Simplematica.LOGGER.error("setBlockEntity: Can't set block entity at pos '{}', because the Tile Entities' Block '{}' doesn't match '{}'",
