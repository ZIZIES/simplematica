package fi.dy.masa.simplematica.tool;
...
{
    AREA_SELECTION      ("area_selection",      "simplematica.tool_mode.name.area_selection",        false),
    SCHEMATIC_PLACEMENT ("schematic_placement", "simplematica.tool_mode.name.schematic_placement",   true);
