...
//        x += this.createTabButton(x, y, -1, ConfigGuiTab.RENDER_LAYERS);
    ...
    {
        String label = StringUtils.translate("simplematica.gui.label.render_layers.hotkey");
        String hover = StringUtils.translate("simplematica.gui.label.render_layers.hover.hotkey");
