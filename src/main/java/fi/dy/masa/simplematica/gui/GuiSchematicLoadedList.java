...
import fi.dy.masa.simplematica.gui.widgets.WidgetListLoadedSchematics;
import fi.dy.masa.simplematica.gui.widgets.WidgetSchematicEntry;
...
public class GuiSchematicLoadedList extends GuiListBase<LitematicaSchematic, WidgetSchematicEntry, WidgetListLoadedSchematics>
{
    public GuiSchematicLoadedList()
    {
        ...
        this.title = StringUtils.translate("simplematica.gui.title.manage_loaded_schematics");
    }
