...
public class GuiConfigs extends GuiConfigsBase implements IConfigGuiAllTab
{
    public GuiConfigs()
    {
        super(10, 50, Reference.MOD_ID, null, "simplematica.gui.title.configs", String.format("%s", Reference.MOD_VERSION));
    }
...
//        }
    ...
    public enum ConfigGuiTab
    {
        ...
        GENERIC         ("simplematica.gui.button.config_gui.generic"),
        INFO_OVERLAYS   ("simplematica.gui.button.config_gui.info_overlays"),
        VISUALS         ("simplematica.gui.button.config_gui.visuals"),
        COLORS          ("simplematica.gui.button.config_gui.colors"),
        HOTKEYS         ("simplematica.gui.button.config_gui.hotkeys"),
        RENDER_LAYERS   ("simplematica.gui.button.config_gui.render_layers");
        //TEST            ("simplematica.gui.button.config_gui.test");
