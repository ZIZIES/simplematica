...
import fi.dy.masa.simplematica.gui.widgets.WidgetListSelectionSubRegions;
import fi.dy.masa.simplematica.gui.widgets.WidgetSelectionSubRegion;
import fi.dy.masa.simplematica.materials.MaterialListAreaAnalyzer;
...
import fi.dy.masa.simplematica.util.SchematicUtils;
                                          ...
                                          implements ISelectionListener<String>
{
    ...
    public GuiAreaSelectionEditorNormal(AreaSelection selection)
    {
        ...
        {
            this.title = StringUtils.translate("simplematica.gui.title.area_editor_normal");
        }
    }
    ...
    public void initGui()
    {
        ...
        {
            this.addLabel(20, 30, 120, 12, 0xFFFFAA00, StringUtils.translate("simplematica.error.area_editor.no_selection"));
        }
    }
    ...
    protected void createSelectionEditFields()
    {
        ...
        this.addLabel(x, y, -1, 16, 0xFFFFFFFF, StringUtils.translate("simplematica.gui.label.area_editor.selection_name"));
        y += 13;
    ...
    protected int addSubRegionFields(int x, int y)
    {
        ...
        this.addLabel(x, y, -1, 16, 0xFFFFFFFF, GuiBase.TXT_BOLD + StringUtils.translate("simplematica.gui.label.area_editor.sub_regions", str));
    ...
    protected void addRenderingDisabledWarning(int x, int y)
    {
        if (Configs.Visuals.ENABLE_AREA_SELECTION_RENDERING.getBooleanValue() == false)
        {
            ...
            String str = StringUtils.translate("simplematica.warning.area_editor.area_rendering_disabled", configName, hotkeyName, hotkeyVal);
    ...
    protected int createCoordinateInputs(int x, int y, int width, Corner corner)
    {
        ...
        {
            case CORNER_1:
                label = StringUtils.translate("simplematica.gui.label.area_editor.corner_1");
                widget = new WidgetCheckBox(x, y + 3, Icons.CHECKBOX_UNSELECTED, Icons.CHECKBOX_SELECTED, label);
                this.checkBoxCorner1 = widget;
                break;
            case CORNER_2:
                label = StringUtils.translate("simplematica.gui.label.area_editor.corner_2");
                widget = new WidgetCheckBox(x, y + 3, Icons.CHECKBOX_UNSELECTED, Icons.CHECKBOX_SELECTED, label);
                this.checkBoxCorner2 = widget;
                break;
            case NONE:
                label = StringUtils.translate("simplematica.gui.label.area_editor.origin");
                widget = new WidgetCheckBox(x, y + 3, Icons.CHECKBOX_UNSELECTED, Icons.CHECKBOX_SELECTED, label);
    ...
    protected int createButton(int x, int y, int width, @Nullable Corner corner, ButtonListener.Type type)
    {
        ...
        {
            button.setHoverStrings("simplematica.gui.button.hover.area_editor.shift_for_in_memory");
        }
    ...
    {
        String hover = StringUtils.translate("simplematica.gui.button.hover.plus_minus_tip_ctrl_alt_shift");
    ...
    protected static class ButtonListener implements IButtonActionListener
    {
        ...
        public void actionPerformedWithButton(ButtonBase button, int mouseButton)
        {
            ...
            switch (this.type)
            {
                ...
                case CHANGE_SELECTION_MODE:
                    ...
                    {
                        this.parent.addMessage(MessageType.WARNING, "simplematica.error.area_editor.switch_mode.no_selection");
                    }
                    else
                    {
                ...
                {
                    GuiTextInput gui = new GuiTextInput(512, "simplematica.gui.title.area_editor.sub_region_name", "", null, new SubRegionCreator(this.parent));
        ...
        public enum Type
        {
            SET_SELECTION_NAME      ("simplematica.gui.button.area_editor.set_selection_name"),
            SET_BOX_NAME            ("simplematica.gui.button.area_editor.set_box_name"),
            TOGGLE_ORIGIN_ENABLED   ("simplematica.gui.button.area_editor.origin_enabled"),
            CREATE_SUB_REGION       ("simplematica.gui.button.area_editor.create_sub_region"),
            CREATE_SCHEMATIC        ("simplematica.gui.button.area_editor.create_schematic"),
            ANALYZE_AREA            ("simplematica.gui.button.area_editor.analyze_area"),
            CHANGE_SELECTION_MODE   ("simplematica.gui.button.area_editor.change_selection_mode"),
            CHANGE_CORNER_MODE      ("simplematica.gui.button.area_editor.change_corner_mode"),
            MOVE_TO_PLAYER          ("simplematica.gui.button.move_to_player"),
            NUDGE_COORD_X           (""),
            NUDGE_COORD_Y           (""),
            NUDGE_COORD_Z           ("");
