...
import fi.dy.masa.simplematica.materials.MaterialListBase.SortCriteria;
...
public class WidgetMaterialListEntry extends WidgetListEntrySortable<MaterialListEntry>
{
    private static final String[] HEADERS = new String[] {
            "simplematica.gui.label.material_list.title.item",
            "simplematica.gui.label.material_list.title.total",
            "simplematica.gui.label.material_list.title.missing",
            "simplematica.gui.label.material_list.title.available" };
            ...
            MaterialListBase materialList, @Nullable MaterialListEntry entry, int listIndex, WidgetListMaterialList listWidget)
    {
        ...
        this.shulkerBoxAbbr = StringUtils.translate("simplematica.gui.label.material_list.abbr.shulker_box");
...
//            ctx.getMatrices().push();
            ...
            fi.dy.masa.simplematica.render.RenderUtils.renderBackgroundMask(ctx, x + 1, y + 1, totalWidth - 2, 58);
...
//            ctx.getMatrices().pop();
            ...
            implements IButtonActionListener
	{
		...
		{
			IGNORE  ("simplematica.gui.button.material_list.ignore");
