...
public class WidgetSchematicEntry extends WidgetListEntryBase<LitematicaSchematic>
{
    ...
    public void postRenderHovered(GuiContext ctx, int mouseX, int mouseY, boolean selected)
    {
            ...
            GuiBase.isMouseOver(mouseX, mouseY, this.buttonsStartX - 13, this.y + 6, 11, 11))
        {
            ...
            List<String> strs = ImmutableList.of(StringUtils.translate("simplematica.gui.label.loaded_schematic.modified_on", str));
        ...
        else if (GuiBase.isMouseOver(mouseX, mouseY, this.x, this.y, this.buttonsStartX - 12, this.height))
        {
            ...
            {
                lines.add(StringUtils.translate("simplematica.gui.label.schematic_placement.in_memory"));
            }
			...
			implements IButtonActionListener
	{
		...
		public enum Type
		{
			CREATE_PLACEMENT        ("simplematica.gui.button.create_placement"),
			RELOAD                  ("simplematica.gui.button.reload", "simplematica.gui.button.hover.schematic_list.reload_schematic"),
			SAVE_TO_FILE            ("simplematica.gui.button.save_to_file"),
			UNLOAD                  ("simplematica.gui.button.unload");
