...
public class GuiAreaSelectionEditorSimple extends GuiAreaSelectionEditorNormal
{
    ...
    public GuiAreaSelectionEditorSimple(AreaSelection selection)
    {
        ...
        this.title = StringUtils.translate("simplematica.gui.title.area_editor_simple");
    }
    ...
    {
        x = 12;
        String label = StringUtils.translate("simplematica.gui.label.area_editor.box_name");
