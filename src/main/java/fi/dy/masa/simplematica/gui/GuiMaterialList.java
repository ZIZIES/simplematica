...
import fi.dy.masa.simplematica.gui.widgets.WidgetListMaterialList;
import fi.dy.masa.simplematica.gui.widgets.WidgetMaterialListEntry;
import fi.dy.masa.simplematica.materials.*;
import fi.dy.masa.simplematica.materials.json.MaterialListJson;
import fi.dy.masa.simplematica.materials.json.MaterialListJsonCache;
...
//
//        String str = StringUtils.translate("simplematica.gui.label.material_list.multiplier");
...
//
//        this.addWidget(new WidgetInfoIcon(this.getScreenWidth() - 23, 10, Icons.INFO_11, "simplematica.info.material_list"));
//
//        int gap = 1;
...
//            String strp;
//            String strt = StringUtils.translate("simplematica.gui.label.material_list.total", total);
//
//            if (missing == 0 && mismatch == 0)
//            {
//                strp = StringUtils.translate("simplematica.gui.label.material_list.progress.done", String.format("%.0f %%%%", pctDone));
//            }
//            else
//            {
//                String str1 = StringUtils.translate("simplematica.gui.label.material_list.progress.done", String.format("%.1f %%%%", pctDone));
//                String str2 = StringUtils.translate("simplematica.gui.label.material_list.progress.missing", String.format("%.1f %%%%", pctMissing));
//                String str3 = StringUtils.translate("simplematica.gui.label.material_list.progress.mismatch", String.format("%.1f %%%%", pctMismatch));
//                strp = String.format("%s / %s / %s", str1, str2, str3);
//            }
//
//            str = strt + " / " + StringUtils.translate("simplematica.gui.label.material_list.progress", strp);
...
//        {
//            this.addMessage(MessageType.WARNING, 3000, "simplematica.message.warn.material_list.no_player_inv");
//        }
...
//        {
//            button.setHoverStrings("simplematica.gui.button.hover.material_list.clear_cache");
//        }
//        else if (type == ButtonListener.Type.WRITE_TO_FILE)
//        {
//            button.setHoverStrings("simplematica.gui.button.hover.material_list.write_hold_shift_for_csv");
//        }
//        else if (type == ButtonListener.Type.WRITE_TO_JSON)
//        {
//            button.setHoverStrings("simplematica.gui.button.hover.material_list.json_hold_shift_for_missing_only");
//        }
//        else if (type == ButtonListener.Type.EXPORT)
//        {
//            button.setHoverStrings("simplematica.gui.button.hover.material_list.export_custom_json");
//        }
...
//        width += this.getStringWidth(ButtonListener.Type.WRITE_TO_JSON.getDisplayName());
        ...
        width += this.getStringWidth(StringUtils.translate("simplematica.gui.label.material_list.multiplier"));
        width += 130;
    ...
    private record ButtonListener(Type type, GuiMaterialList parent) implements IButtonActionListener
    {
        ...
        public void actionPerformedWithButton(ButtonBase button, int mouseButton)
        {
            ...
            switch (this.type)
            {
                ...
                case CLEAR_CACHE:
                    ...
                    this.parent.addMessage(MessageType.SUCCESS, 3000, "simplematica.message.material_list.material_cache_cleared");
                    break;
                ...
                case EXPORT:
                    if (this.parent.exportType == ExportType.WRITE_TO_FILE)
                    {
                        ...
                        if (file != null)
                        {
                            String key = "simplematica.message.material_list_written_to_file";
                    ...
                    else if (this.parent.exportType == ExportType.WRITE_TO_JSON)
                    {
                        ...
                        {
                            String key = "simplematica.message.error.json_material_list_copy_failure";
                        ...
                        {
                            String key = "simplematica.message.error.json_material_list_failure";
                            this.parent.addMessage(MessageType.ERROR, key, jsonFile.getFileName().toString());
                            cache.clearAll();
                            jsonWriter.clear();
                            break;
                        ...
                        {
                            String key = "simplematica.message.material_list_written_to_json_file";
        ...
        public enum Type
        {
            REFRESH_LIST        ("simplematica.gui.button.material_list.refresh_list"),
            LIST_TYPE           ("simplematica.gui.button.material_list.list_type"),
            HIDE_AVAILABLE      ("simplematica.gui.button.material_list.hide_available"),
            TOGGLE_INFO_HUD     ("simplematica.gui.button.material_list.toggle_info_hud"),
            CLEAR_IGNORED       ("simplematica.gui.button.material_list.clear_ignored"),
            CLEAR_CACHE         ("simplematica.gui.button.material_list.clear_cache", "simplematica.gui.button.hover.material_list.clear_cache"),
            EXPORT              ("simplematica.gui.button.material_list.export",      "simplematica.gui.button.hover.material_list.export_as"),
            EXPORT_TYPE         (""),
//            WRITE_TO_FILE       ("simplematica.gui.button.material_list.write_to_file"),
//            WRITE_TO_JSON       ("simplematica.gui.button.material_list.write_to_json"),
//            EXPORT              ("simplematica.gui.button.material_list.export"),
            ;
    ...
    {
        WRITE_TO_FILE       ("simplematica.gui.button.material_list.write_to_file",       "simplematica.gui.button.hover.material_list.write_hold_shift_for_csv"),
        WRITE_TO_JSON       ("simplematica.gui.button.material_list.write_to_json",       "simplematica.gui.button.hover.material_list.json_hold_shift_for_missing_only"),
        CUSTOM_JSON         ("simplematica.gui.button.material_list.export_custom_json",  "simplematica.gui.button.hover.material_list.export_custom_json"),
        ;
