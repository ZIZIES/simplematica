...
import fi.dy.masa.simplematica.gui.widgets.WidgetListPlacementSubRegions;
import fi.dy.masa.simplematica.gui.widgets.WidgetPlacementSubRegion;
                                        ...
                                        implements ISelectionListener<SubRegionPlacement>
{
    ...
    public GuiPlacementConfiguration(SchematicPlacement placement)
    {
        ...
        this.title = StringUtils.translate("simplematica.gui.title.configure_schematic_placement");
    }
    ...
    public void initGui()
    {
        ...
        String label = StringUtils.translate("simplematica.gui.label.schematic_placement.sub_regions", this.placement.getSubRegionCount());
        ...
        label = StringUtils.translate("simplematica.gui.label.placement_settings.placement_origin");
    ...
    protected void createCoordinateInput(int x, int y, int width, CoordinateType type)
    {
        ...
        String hover = StringUtils.translate("simplematica.hud.schematic_placement.hover_info.lock_coordinate");
        x = x + offset + width + 20;
    ...
    public int createButton(int x, int y, int width, ButtonListener.Type type)
    {
        ...
        switch (type)
        {
            case TOGGLE_ENCLOSING_BOX:
            {
                ...
                String str = (enabled ? TXT_GREEN : TXT_RED) + StringUtils.translate("simplematica.message.value." + (enabled ? "on" : "off")) + TXT_RST;
                String hover = StringUtils.translate("simplematica.gui.button.schematic_placement.hover.enclosing_box", str);
            ...
            case TOGGLE_RENDERING:
            {
                ...
                String str = pre + StringUtils.translate("simplematica.message.value." + (enabled ? "on" : "off")) + TXT_RST;
                String hover = StringUtils.translate("simplematica.gui.button.schematic_placement.hover.rendering", str);
            ...
            case NUDGE_COORD_Z:
            {
                String hover = StringUtils.translate("simplematica.gui.button.hover.plus_minus_tip");
    ...
    {
        String label = StringUtils.translate("simplematica.gui.button.schematic_placement.reset_sub_region_placements");;
            ...
            implements IButtonActionListener
    {
        ...
        public enum Type
        {
            RENAME_PLACEMENT        ("simplematica.gui.button.rename"),
            ROTATE                  ("simplematica.gui.button.rotation_value"),
            MIRROR                  ("simplematica.gui.button.mirror_value"),
            MOVE_TO_PLAYER          ("simplematica.gui.button.move_to_player"),
            NUDGE_COORD_X           (""),
            NUDGE_COORD_Y           (""),
            NUDGE_COORD_Z           (""),
            TOGGLE_ENABLED          ("simplematica.gui.button.schematic_placements.placement_enabled"),
            TOGGLE_RENDERING        ("simplematica.gui.button.schematic_placement.abbr.rendering"),
            TOGGLE_LOCKED           ("simplematica.gui.button.schematic_placements.locked", "simplematica.gui.button.schematic_placement.hover.lock"),
            TOGGLE_ENTITIES         ("simplematica.gui.button.schematic_placement.ignore_entities"),
            TOGGLE_ENCLOSING_BOX    (""),
            TOGGLE_ALL_REGIONS_ON   ("simplematica.gui.button.schematic_placement.toggle_all_on"),
            TOGGLE_ALL_REGIONS_OFF  ("simplematica.gui.button.schematic_placement.toggle_all_off"),
            RESET_SUB_REGIONS       (""),
            OPEN_VERIFIER_GUI       ("simplematica.gui.button.schematic_verifier"),
            OPEN_MATERIAL_LIST_GUI  ("simplematica.gui.button.material_list");
