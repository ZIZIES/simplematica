...
public class GuiSchematicSaveImported extends GuiSchematicSaveBase
{
    ...
    public GuiSchematicSaveImported(DirectoryEntryType type, Path dirSource, String inputFileName)
    {
        ...
        this.title = StringUtils.translate("simplematica.gui.title.save_imported_schematic");
            ...
            if (this.type == ButtonType.SAVE)
            {
                ...
                if (this.gui.type == DirectoryEntryType.FILE)
                {
                    ...
                    if (fileType == FileType.LITEMATICA_SCHEMATIC)
                    {
                        ...
                        {
                            this.gui.addMessage(MessageType.SUCCESS, "simplematica.message.litematic_saved_as", fileName);
                ...
                this.gui.addMessage(MessageType.ERROR, "simplematica.error.schematic_load.unsupported_type", this.gui.inputFileName);
            }
        }
    }
}
