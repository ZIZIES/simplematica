...
import fi.dy.masa.simplematica.gui.GuiSubRegionConfiguration;
...
public class WidgetPlacementSubRegion extends WidgetListEntryBase<SubRegionPlacement>
{
    ...
    public void postRenderHovered(GuiContext ctx, int mouseX, int mouseY, boolean selected)
    {
        ...
        {
            String str = StringUtils.translate("simplematica.hud.schematic_placement.hover_info.placement_sub_region_modified");
        ...
        else if (GuiBase.isMouseOver(mouseX, mouseY, this.x, this.y, this.buttonsStartX - 14, this.height))
        {
            ...
            text.add(StringUtils.translate("simplematica.gui.label.schematic_placement.schematic_name", schematic.getMetadata().getName()));
            ...
            if (size != null)
            {
                ...
                text.add(StringUtils.translate("simplematica.gui.label.placement_sub.region_size", strSize));
            }
            ...
            implements IButtonActionListener
	{
		...
		public void actionPerformedWithButton(ButtonBase button, int mouseButton)
		{
			...
			{
				GuiSubRegionConfiguration gui
						= new GuiSubRegionConfiguration(this.widget.schematicPlacement, this.widget.placement);
