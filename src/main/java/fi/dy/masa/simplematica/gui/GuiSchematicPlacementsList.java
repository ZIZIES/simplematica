...
import fi.dy.masa.simplematica.gui.widgets.WidgetListSchematicPlacements;
import fi.dy.masa.simplematica.gui.widgets.WidgetSchematicPlacement;
...
public class GuiSchematicPlacementsList extends GuiListBase<SchematicPlacement, WidgetSchematicPlacement, WidgetListSchematicPlacements> implements ISelectionListener<SchematicPlacement>
{
    ...
    public GuiSchematicPlacementsList()
    {
        ...
        this.title = StringUtils.translate("simplematica.gui.title.manage_schematic_placements");
