...
public class GuiSubRegionConfiguration extends GuiBase
{
    ...
    public GuiSubRegionConfiguration(SchematicPlacement schematicPlacement, SubRegionPlacement placement)
    {
        ...
        this.title = StringUtils.translate("simplematica.gui.title.configure_schematic_sub_region");
    }
    ...
    public void initGui()
    {
        ...
        String label = StringUtils.translate("simplematica.gui.label.placement_sub.region_name", this.placement.getName());
        ...
        label = StringUtils.translate("simplematica.gui.label.placement_sub.region_position");
        ...
        label = StringUtils.translate("simplematica.gui.button.placement_sub.placement_configuration");
    ...
    {
        String label = StringUtils.translate("simplematica.gui.button.placement_sub.reset_sub_region_placement");
    ...
    private static class ButtonListener implements IButtonActionListener
    {
        ...
        public enum Type
        {
            ...
            TOGGLE_ENABLED          ("simplematica.gui.button.schematic_placement.region_enabled"),
            ...
            RESET_PLACEMENT         (""),
            SLICE_TYPE              ("simplematica.gui.button.placement_sub.slice_type");
