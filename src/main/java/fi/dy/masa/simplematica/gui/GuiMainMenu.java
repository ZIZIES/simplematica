...
public class GuiMainMenu extends GuiBase
{
    public GuiMainMenu()
    {
        ...
        this.title = StringUtils.translate("simplematica.gui.title.litematica_main_menu", version);
    }
    ...
    public void initGui()
    {
        ...
        String label = StringUtils.translate("simplematica.gui.button.area_selection_mode", mode.getDisplayName());
        ButtonGeneric button = new ButtonGeneric(x, y, width, 20, label);
        this.addButton(button, new ButtonListenerCycleAreaMode(this));

        label = StringUtils.translate("simplematica.gui.button.tool_mode", DataManager.getToolMode().getName());
    ...
    public static class ButtonListenerChangeMenu implements IButtonActionListener
    {
        ...
        public enum ButtonType
        {
            ...
            LOADED_SCHEMATICS           ("simplematica.gui.button.change_menu.show_loaded_schematics", ButtonIcons.LOADED_SCHEMATICS),
            // List Schematics placements
            SCHEMATIC_PLACEMENTS        ("simplematica.gui.button.change_menu.show_schematic_placements", ButtonIcons.SCHEMATIC_PLACEMENTS),
            // Open the Area Selection browser
            AREA_SELECTION_BROWSER      ("simplematica.gui.button.change_menu.show_area_selections", ButtonIcons.AREA_SELECTION),
            // Open the Area Editor GUI
            AREA_EDITOR                 ("simplematica.gui.button.change_menu.area_editor", ButtonIcons.AREA_EDITOR),
            // Load Schematics from file to memory
            LOAD_SCHEMATICS             ("simplematica.gui.button.change_menu.load_schematics_to_memory", ButtonIcons.SCHEMATIC_BROWSER),
            // Edit Schematics (description or icon), or convert between formats
            SCHEMATIC_MANAGER           ("simplematica.gui.button.change_menu.schematic_manager", ButtonIcons.SCHEMATIC_MANAGER),
            // Open the Task Manager
            TASK_MANAGER                ("simplematica.gui.button.change_menu.task_manager", ButtonIcons.TASK_MANAGER),
            // In-game Configuration GUI
            CONFIGURATION               ("simplematica.gui.button.change_menu.configuration_menu", ButtonIcons.CONFIGURATION),
            // Switch to the Simplematica main menu
            MAIN_MENU                   ("simplematica.gui.button.change_menu.to_main_menu", null);
