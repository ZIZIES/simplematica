...
import fi.dy.masa.simplematica.gui.widgets.WidgetListTasks;
import fi.dy.masa.simplematica.gui.widgets.WidgetTaskEntry;
...
public class GuiTaskManager extends GuiListBase<ITask, WidgetTaskEntry, WidgetListTasks>
{
    public GuiTaskManager()
    {
        ...
        this.title = StringUtils.translate("simplematica.gui.title.task_manager");
    }
