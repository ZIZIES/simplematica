...
import fi.dy.masa.simplematica.render.schematic.WorldRendererSchematic;
...
public class LitematicaRenderer
{
    ...
    {
//        Simplematica.LOGGER.error("LitematicaRenderer.onEndFrame()");
...
//        }
    ...
    public void onClose()
    {
//        Simplematica.LOGGER.error("LitematicaRenderer.onClose()");
