package fi.dy.masa.simplematica.compat.iris;
...
import fi.dy.masa.simplematica.mixin.client.IMixinActiveProfiler;
...
//	{
////		Simplematica.LOGGER.warn("[IrisFix] extractCameraWithShadersOn()");
...
//	{
////		Simplematica.LOGGER.warn("[IrisFix] extractFogBufferWithShadersOn()");
...
//	{
////		Simplematica.LOGGER.warn("[IrisFix] setCamera()");
//		this.camera = camera;
//	}
//
...
//		{
////			Simplematica.LOGGER.warn("[IrisFix] extractAndCompileSectionsWithShadersOn()");
...
//		if (IrisCompat.isShaderActive() && this.hasWorld() && this.mc.isGameLoadFinished())
//		{
////			Simplematica.LOGGER.error("[IrisFix] renderMainPassWithShadersOn()");
