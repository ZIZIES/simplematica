...
//		}
//
//		Simplematica.LOGGER.info("Sodium: [{}], Iris: [{}]", isSodiumLoaded ? sodiumVersion : "N/F", isIrisLoaded ? irisVersion : "N/F");
//	}
//
...
//		if (hasIris())
//		{
//			Simplematica.LOGGER.info("Assigning Simplematica Pipelines to Iris Programs:");
//
//			// TERRAIN
