...
public class SubRegionPlacement
{
    ...
    public static SubRegionPlacement fromJson(JsonObject obj)
    {
            ...
            JsonUtils.hasString(obj, "mirror"))
        {
            ...
            if (posArr.size() != 3)
            {
                Simplematica.LOGGER.warn("Placement.fromJson(): Failed to load a placement from JSON, invalid position data");
                return null;
            }
            ...
            {
                Simplematica.LOGGER.warn("Placement.fromJson(): Invalid rotation or mirror value for a placement");
            }
