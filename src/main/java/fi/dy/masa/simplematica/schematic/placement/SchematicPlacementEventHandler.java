...
import fi.dy.masa.simplematica.interfaces.ISchematicPlacementEventListener;
import fi.dy.masa.simplematica.interfaces.ISchematicPlacementEventManager;
...
public class SchematicPlacementEventHandler implements ISchematicPlacementEventManager
{
                                                        ...
                                                        @Nonnull List<SchematicPlacementEventFlag> flags)
    {
        if (flags.isEmpty())
        {
            Simplematica.LOGGER.warn("registerSchematicPlacementEventListener: provided event flags for '{}' are empty.  Ignoring.",
