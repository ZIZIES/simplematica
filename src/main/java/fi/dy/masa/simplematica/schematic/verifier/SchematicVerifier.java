package fi.dy.masa.simplematica.schematic.verifier;
...
import fi.dy.masa.simplematica.render.infohud.IInfoHudRenderer;
...
import fi.dy.masa.simplematica.scheduler.tasks.TaskBase;
...
public class SchematicVerifier extends TaskBase implements IInfoHudRenderer
{
    ...
    {
        this.name = StringUtils.translate("simplematica.gui.label.schematic_verifier.verifier");
    }
    ...
    public List<Pair<BlockState, BlockState>> getIgnoredStateMismatchPairs(GuiBase gui)
    {
        ...
        {
            gui.addMessage(MessageType.ERROR, "simplematica.error.generic.failed_to_sort_list_of_ignored_states");
        }
    ...
    private void updateMismatchPositionStringList(@Nullable MismatchType mismatchType, List<MismatchRenderPos> positionList)
    {
        ...
        if (positionList.isEmpty() == false)
        {
            ...
            {
                String title = StringUtils.translate("simplematica.gui.title.schematic_verifier_errors");
    ...
    */
    ...
    {
        ALL             (0xFF0000, "simplematica.gui.label.schematic_verifier_display_type.all", GuiBase.TXT_WHITE),
        MISSING         (0x00FFFF, "simplematica.gui.label.schematic_verifier_display_type.missing", GuiBase.TXT_AQUA),
        EXTRA           (0xFF00CF, "simplematica.gui.label.schematic_verifier_display_type.extra", GuiBase.TXT_LIGHT_PURPLE),
        WRONG_BLOCK     (0xFF0000, "simplematica.gui.label.schematic_verifier_display_type.wrong_blocks", GuiBase.TXT_RED),
        WRONG_STATE     (0xFFAF00, "simplematica.gui.label.schematic_verifier_display_type.wrong_state", GuiBase.TXT_GOLD),
        CORRECT_STATE   (0x11FF11, "simplematica.gui.label.schematic_verifier_display_type.correct_state", GuiBase.TXT_GREEN),
        DIFF_BLOCK      (0xFAF000, "simplematica.gui.label.schematic_verifier_display_type.diff_blocks", GuiBase.TXT_YELLOW);
