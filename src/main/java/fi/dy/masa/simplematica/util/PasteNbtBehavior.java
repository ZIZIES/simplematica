...
{
    NONE            ("none",              "simplematica.gui.label.paste_nbt_behavior.none"),
    PLACE_MODIFY    ("place_data_modify", "simplematica.gui.label.paste_nbt_behavior.place_data_modify"),
    PLACE_CLONE     ("place_clone",       "simplematica.gui.label.paste_nbt_behavior.place_clone");
