...
{
    ALWAYS                  ("always",      "simplematica.gui.label.data_fixer_mode.always"),
    BELOW_1215              ("below_1215",  "simplematica.gui.label.data_fixer_mode.below_1215"),
    BELOW_1205              ("below_1205",  "simplematica.gui.label.data_fixer_mode.below_1205"),
    BELOW_120X              ("below_120X",  "simplematica.gui.label.data_fixer_mode.below_120X"),
    BELOW_119X              ("below_119X",  "simplematica.gui.label.data_fixer_mode.below_119X"),
    BELOW_117X              ("below_117X",  "simplematica.gui.label.data_fixer_mode.below_117X"),
    BELOW_116X              ("below_116X",  "simplematica.gui.label.data_fixer_mode.below_116X"),
    BELOW_113X              ("below_113X",  "simplematica.gui.label.data_fixer_mode.below_113X"),
    BELOW_112X              ("below_112X",  "simplematica.gui.label.data_fixer_mode.below_112X"),
    NEVER                   ("never",       "simplematica.gui.label.data_fixer_mode.never");
