...
{
    NONE            ("none",            "simplematica.gui.label.replace_behavior.none"),
    ALL             ("all",             "simplematica.gui.label.replace_behavior.all"),
    WITH_NON_AIR    ("with_non_air",    "simplematica.gui.label.replace_behavior.with_non_air");
