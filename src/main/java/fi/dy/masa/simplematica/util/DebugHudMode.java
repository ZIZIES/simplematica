...
{
	DEFAULT     ("default",      "simplematica.gui.label.debug_info_mode.default"),
	VANILLA     ("vanilla",      "simplematica.gui.label.debug_info_mode.vanilla"),
	NONE        ("none",         "simplematica.gui.label.debug_info_mode.none"),
	;
