...
import fi.dy.masa.simplematica.scheduler.tasks.TaskCountBlocksArea;
...
public class MaterialListAreaAnalyzer extends MaterialListBase
{
    ...
    {
        return StringUtils.translate("simplematica.gui.title.material_list.area_analyzer", this.getName());
    }
